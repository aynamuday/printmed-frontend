            ...
            <div className="">
              <div className="relative w-full max-w-5xl mx-auto bg-gray-100 pt-8 pb-10 rounded-lg shadow-md mb-6">
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 place-items-center justify-center">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 gap-x-6 w-full px-4 sm:px-8">
                    {/* First Name */}
                    <div>
                  ...
                  <div className="">
                    <button 
                      type="submit" 
                      className="w-full mt-4 sm:w-auto px-6 py-2 bg-[#248176] hover:bg-[#379c90] text-white font-semibold rounded-md text-center"
                      >
                        Add Patient
                    </button>
                  </div>
