    ...
    <>
      ...
      <Header />
        <div className="px-4 sm:px-6 mt-4">
          <div className="flex flex-col items-center justify-center bg-[#98e6dd] bg-opacity-50 p-6 sm:p-10 md:p-16 rounded-lg shadow-lg w-full max-w-5xl mx-auto mb-12">
            <div className="">
