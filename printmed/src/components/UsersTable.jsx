      ...
      <table className="min-w-full border border-spacing-0 border-gray-300">
        <thead>
          <tr>
            ...
            <th className="bg-[#D9D9D9] border border-[#828282] p-0.5 text-center w-[10%]">Middle Name</th>
          ...
          {users && users.length > 0 ? (
            users.map((item) => (
              <tr key={item.id}>
                ...
                <td className="border p-0.5 border-[#828282] text-center">{item.middle_name}</td>
