...
const PatientsTable = ({ patients, handleViewClickProp }) => {
  ...
  const handleViewClickChange = (index) => {
    ...
    <>
      <div className="w-full md:w-[75%] md:ml-[22%] p-6">
        <table className="min-w-full border border-spacing-0 border-gray-300">
          <thead>
            <tr>
              <th className="p-2 border text-center bg-[#D9D9D9] border-[#828282] w-[15%]">Patient Number</th>
              <th className="p-2 border text-center bg-[#D9D9D9] border-[#828282] w-[25%]">First Name</th>
              <th className="p-2 border text-center bg-[#D9D9D9] border-[#828282] w-[25%]">Last Name</th>
              <th className="p-2 border text-center bg-[#D9D9D9] border-[#828282] w-[5%]">Age</th>
              <th className="p-2 border text-center bg-[#D9D9D9] border-[#828282] w-[10%]">Birthdate</th>
              <th className="p-2 border text-center bg-[#D9D9D9] border-[#828282] w-[10%]">Sex</th>
              <th className="p-2 border text-center bg-[#D9D9D9] border-[#828282] w-[10%]">Actions</th>
            </tr>
          </thead>
          <tbody>
                  ...
                  <td className="p-2 border text-center border-[#828282]">
                    <div className="flex justify-center gap-2">
                      <button
                        ...
                        onClick={() => handleViewClickChange(patient.patient_number)} 
                      >
                        View
                      </button>
                    </div>
